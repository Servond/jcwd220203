...
const ModalEditCategory = ({ isOpenEditCategory, onOpenEditCategory, onCloseEditCategory, editFormik, category_name, editChangeHandler, selectImage, setSelectImage, apiImg, category_image, inputFileRef, closeEditModal }) => {
