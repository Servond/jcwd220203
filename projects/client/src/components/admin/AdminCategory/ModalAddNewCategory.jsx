...
const ModalAddNewCategory = ({ inputFileRef, closeAddNewModal, isOpenAddNewCategory, onCloseAddNewCategory, formikAddNewCategory, inputChangeHandler, selectImage, setSelectImage, doubleOnClick }) => {
            ...
            <form onSubmit={formikAddNewCategory.handleSubmit}>
                ...
                <ModalContent borderRadius={'10px'} mt={'120px'}>
                    ...
                    <ModalFooter>
                        ...
                        <Button colorScheme="green" mr={3} onClick={doubleOnClick} borderRadius={'8px'} isDisabled={!formikAddNewCategory.values.category_name || !formikAddNewCategory.values.category_image}>
                            Create
                        </Button>
                    </ModalFooter>
                </ModalContent>
