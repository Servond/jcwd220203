          ...
          <ModalContent mt={"90px"} borderRadius="8px" overflow={false}>
            ...
            >
              ...
              <Box mt="34px" mb="4px">
                ...
                <FormControl
                  isInvalid={formikAddNewAddress.errors.recipients_name}
                >
                  <Input
                    value={formikAddNewAddress.values.recipients_name}
                    name="recipients_name"
                    type="text"
                    onChange={formChangeHandler}
                  />
                  <FormErrorMessage>
                    {formikAddNewAddress.errors.recipients_name}
                  </FormErrorMessage>
                </FormControl>
              </Box>
              ...
              <Box mt="12px">
                ...
                <FormControl
                  isInvalid={formikAddNewAddress.errors.phone_number}
                >
                  <Input
                    value={formikAddNewAddress.values.phone_number}
                    name="phone_number"
                    type="number"
                    maxLength={15}
                    minLength={9}
                  ...
                  />
                  <FormErrorMessage>
                    {formikAddNewAddress.errors.phone_number}
                  </FormErrorMessage>
                </FormControl>
              </Box>
              ...
              <Box mt="34px" mb="4px">
                ...
                <FormControl
                  isInvalid={formikAddNewAddress.errors.address_labels}
                >
                  <Input
                    value={formikAddNewAddress.values.address_labels}
                    name="address_labels"
                    type={"text"}
                    onChange={formChangeHandler}
                  />
                  ...
                  <FormErrorMessage>
                    {formikAddNewAddress.errors.address_labels}
                  </FormErrorMessage>
                </FormControl>
              </Box>
              ...
              <Box mt="12px">
                <Grid templateColumns={"repeat(2, 1fr)"} gap="4">
                  <Box>
                    ...
                    <FormControl
                      isInvalid={formikAddNewAddress.errors.province}
                    >
                      <Select
                        onChange={provinceHandler}
                        placeholder="Select Province"
                        // value={formikAddNewAddress.values.province}
                      >
                        {renderProvince()}
                      </Select>
                      <FormErrorMessage>
                        {formikAddNewAddress.errors.province}
                      </FormErrorMessage>
                    </FormControl>
                  </Box>
                  <Box>
                    <FormLabel mb={"8px"}>City</FormLabel>
                    <FormControl isInvalid={formikAddNewAddress.errors.city}>
                      <Select onChange={cityHandler} placeholder="Select City">
                        {/* {renderCity()} */}
                      </Select>
                      <FormErrorMessage>
                        {formikAddNewAddress.errors.city}
                      </FormErrorMessage>
                    </FormControl>
                  </Box>
                  <Box>
                  ...
                  <Box>
                    ...
                    <FormControl
                    // isInvalid={formikAddNewAddress.errors.city}
                    >
              ...
              <Box mt="34px" mb="4px">
                ...
                <FormControl
                  isInvalid={formikAddNewAddress.errors.full_address}
                >
                  <Textarea
                    value={formikAddNewAddress.values.full_address}
                    name="full_address"
                    size={"md"}
                    resize="none"
                    maxLength={200}
                  ...
                  <FormErrorMessage>
                    {formikAddNewAddress.errors.full_address}
                  </FormErrorMessage>
                </FormControl>
              </Box>
