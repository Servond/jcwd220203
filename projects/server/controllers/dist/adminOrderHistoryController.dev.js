...
var adminOrderHistoryController = {
                    ...
                    switch ((_context.prev = _context.next)) {
                        case 0:
                            ;(_req$query = req.query),
                                (_req$query$_limit = _req$query._limit),
                                (_limit =
                                    _req$query$_limit === void 0
                                        ? 10
                                        : _req$query$_limit),
                                (_req$query$_page = _req$query._page),
                                (_page =
                                    _req$query$_page === void 0
                                        ? 1
                                        : _req$query$_page)
                        ...
                        case 9:
                            ...
                            transformArr = function transformArr(orig) {
                                ...
                                for (i = 0, j = orig.length; i < j; i++) {
                                    ...
                                    types[cur.TransactionId].prices.push(
                                        cur.price
                                    )
                                    types[cur.TransactionId].qtys.push(cur.qty)
                                    types[cur.TransactionId].descriptions.push(
                                        cur.description
                                    )
                                    types[cur.TransactionId].productIds.push(
                                        cur.productId
                                    )
                                    types[cur.TransactionId].usernames.push(
                                        cur.username
                                    )
                                }
    ...
    getByWarehouseId: function getByWarehouseId(req, res) {
        var _req$query2,
            WarehouseId,
            _req$query2$transacti,
            transaction_name,
            _req$query2$_sortBy,
            _sortBy,
            _req$query2$_sortDir,
            _sortDir,
            _req$query2$_limit,
            _limit,
            _req$query2$_page,
        ...
        return regeneratorRuntime.async(
            function getByWarehouseId$(_context2) {
                while (1) {
                    switch ((_context2.prev = _context2.next)) {
                        case 0:
                            _context2.prev = 0
                            ;(_req$query2 = req.query),
                                (WarehouseId = _req$query2.WarehouseId),
                                (_req$query2$transacti =
                                    _req$query2.transaction_name),
                                (transaction_name =
                                    _req$query2$transacti === void 0
                                        ? ""
                                        : _req$query2$transacti),
                                (_req$query2$_sortBy = _req$query2._sortBy),
                                (_sortBy =
                                    _req$query2$_sortBy === void 0
                                        ? ""
                                        : _req$query2$_sortBy),
                                (_req$query2$_sortDir = _req$query2._sortDir),
                                (_sortDir =
                                    _req$query2$_sortDir === void 0
                                        ? "ASC"
                                        : _req$query2$_sortDir),
                                (_req$query2$_limit = _req$query2._limit),
                                (_limit =
                                    _req$query2$_limit === void 0
                                        ? 10
                                        : _req$query2$_limit),
                                (_req$query2$_page = _req$query2._page),
                                (_page =
                                    _req$query2$_page === void 0
                                        ? 1
                                        : _req$query2$_page)
                            ...
                            return regeneratorRuntime.awrap(
                                Transaction.findAndCountAll({
                                    ...
                                    where: _defineProperty({}, Op.or, {
                                        ...
                                        transaction_name: _defineProperty(
                                            {},
                                            Op.like,
                                            "%".concat(transaction_name, "%")
                                        ),
                                    }),
                                    limit: Number(_limit),
                                    offset: (_page - 1) * _limit,
